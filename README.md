...
- Легкий доступ до всіх відігровок через меню
...
- Відігровки підтримують текст відповідно до обраної статі
- Підтримка модифікаторів що замінюють текст випадковим чином на вказані значення.
...
- Якщо при запуску скрипту з'являється повідомлення, що клавішу на клавіатурі не зайдено - спробуйте перед запуском переключитись на англ. мову та знову запустити скрипт.